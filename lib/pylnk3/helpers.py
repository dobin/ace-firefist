...
from lib.pylnk3.structures import (
...
from lib.pylnk3.structures.id_list.path import TYPE_FOLDER
from lib.pylnk3.structures.id_list.root import ROOT_MY_COMPUTER, ROOT_UWP_APPS
