...
from lib.pylnk3.exceptions import FormatException, InvalidKeyException
from lib.pylnk3.flags import Flags, ModifierKeys
from lib.pylnk3.structures.extra_data import ExtraData, ExtraData_EnvironmentVariableDataBlock
from lib.pylnk3.structures.id_list.id_list import LinkTargetIDList
from lib.pylnk3.structures.link_info import DRIVE_UNKNOWN, LinkInfo
from lib.pylnk3.utils.data import convert_time_to_unix, convert_time_to_windows
from lib.pylnk3.utils.read_write import (
